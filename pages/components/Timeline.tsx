...
const Timeline = () => {
  ...
  return (
    // <div id={timeline.title} className="px-8 sm:px-12 md:px-32 pb-32 flex justify-center align-center flex-col bg-gradient-to-r from-blue-700 via-blue-600 via blue-500 to-white" onClick={goToNextStop}>
    //   <FontAwesomeIcon icon={faArrowUp} />
    // </div>
    <button className="px-8 sm:px-12 md:px-32 pb-32 flex justify-center align-center flex-col bg-gradient-to-r from-blue-700 via-blue-600 via-blue-500 to-white" onClick={goToNextStop}>
  <FontAwesomeIcon icon={faArrowUp} />
</button>
