  ...
  return (
    <section className="h-screen bg-white overflow-x-hidden">
      <div className="px-8 lg:px-32 flex flex-col justify-center align-between">
        ...
        <div className="flex justify-center mt-4">
          <a href="https://www.linkedin.com/in/adam-babs-76124415b/" target="_blank" rel="noreferrer" className="mr-2">
            <img src="/img/linkedinlogo.png" alt="LinkedIn Logo" className="w-6 h-6 inline-block" />
          </a>
          <a href="https://github.com/adambabs" target="_blank" rel="noreferrer">
            <img src="/img/githublogo.png" alt="GitHub Logo" className="w-7 h-7 inline-block" />
          </a>
        </div>
      </div>
    </section>
